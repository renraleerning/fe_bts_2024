...
const deleteJabatan = async () => {
  try {
    await api.delete(`/api/jabatan/${itemId.value}`);
    fetchDataJabatans(); // Pastikan fungsi ini sudah didefinisikan
            ...
            <div class="card-header pb-0">
              ...
              <div class="card-header pb-0">
                ...
                >
                  <!-- Add Bagian Button -->
                  <router-link
                    :to="{ name: 'Create.Jabatan' }"
                    class="btn btn-md btn-success rounded-sm shadow border-0"
                  >
                    <i class="fa fa-user-plus"></i> &nbsp;ADD JABATAN
                  </router-link>
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="text-center">
                      ...
                      ></router-link>
                      <button
                        @click="confirmDelete(jabatan.id)"
                      ...
                      <div>
                        ...
                        >
                          ...
                          <div class="button-container">
                            <button
                              @click.prevent="deleteJabatan(jabatan.id)"
