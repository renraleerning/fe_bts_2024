...
//onMounted
onMounted(async () => {
  //fetch detail data tamu by ID
  await api.get(`/api/tamu/${route.params.id}`).then((response) => {
    ...
    tujuan.value = response.data.data.tujuan;
    nama_tujuan.value = response.data.data.nama_tujuan;
    keperluan.value = response.data.data.keperluan;
    photo.value = response.data.data.photo;
    file.value = response.data.data.file;
  });
});
...
const updateTamu = async () => {
  ...
  //store data with API
  await api
    .post(`/api/tamu/${route.params.id}`, formData)
    .then(() => {
      //redirect
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header pb-0">
            <p class="text-uppercase text-sm fw-bold">
              <i class="fas fa-user-check">&nbsp;&nbsp;</i>IDENTITAS TAMU
            </p>
          </div>
          <div class="card-body">
            <!-- Form Start -->
            <form @submit.prevent="updateTamu">
              ...
              <br />
              <p class="text-uppercase text-sm fw-bold">
                <i class="fas fa-arrow-circle-right">&nbsp;&nbsp;</i>TUJUAN
              </p>
              ...
              <div class="mb-3">
                ...
                <textarea
                  class="form-control"
                  v-model="keperluan"
                  placeholder="Masukan Tujuan Bertamu"
                ></textarea>
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-header pb-0">
            <p class="text-uppercase text-sm fw-bold">
              <i class="fa fa-file">&nbsp;&nbsp;</i>LAMPIRAN FILE
            </p>
          </div>
          <div class="card-body">
            <div class="mb-3">
            ...
            <br />
            <p class="text-uppercase text-sm fw-bold">
              <i class="fa fa-camera">&nbsp;&nbsp;</i>FOTO TAMU
            </p>
            ...
            <div class="mb-3">
              ...
              <button
                @click="capture"
                class="btn btn-md btn-primary rounded-sm shadow border-0 me-2 ms-5"
              >
                Ambil Foto
              </button>
